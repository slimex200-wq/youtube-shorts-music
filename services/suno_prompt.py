...
- exclude_styles: Suno "Exclude styles" 필드. 피해야 할 장르/스타일. 영어. 빈 문자열이면 없음.
- vocal_gender: "Male" 또는 "Female". instrumental이면 null.
- lyrics_mode: "Manual" 또는 "Auto". 가사가 주어지면 Manual, 없으면 Auto.
- weirdness: Suno의 실험성 정도. 0~100 정수. 장르 특성에 맞게 설정.
- style_influence: Suno의 스타일 영향력. 0~100 정수. 프롬프트 충실도.
